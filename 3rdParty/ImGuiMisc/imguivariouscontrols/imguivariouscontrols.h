...
public:
    ...
    void setTreeViewNodePopupMenuDrawerCb(TreeViewNodeCallback cb,void* userData=NULL) {treeViewNodePopupMenuDrawerCb = cb;treeViewNodePopupMenuDrawerCbUserPtr = userData;}
    ...
    void setTreeViewNodeDrawIconCb(TreeViewNodeDrawIconCallback cb,void* userData =NULL) {treeViewNodeDrawIconCb = cb;treeViewNodeDrawIconCbUserPtr = userData;}
    ...
    void setTreeViewNodeAfterDrawCb(TreeViewNodeAfterDrawCallback cb,void* userData =NULL) {treeViewNodeAfterDrawCb = cb;treeViewNodeAfterDrawCbUserPtr = userData;}
    ...
    void setTreeViewNodeCreationDelationCb(TreeViewNodeCreationDelationCallback cb,void* userData =NULL) {treeViewNodeCreationDelationCb = cb;treeViewNodeCreationDelationCbUserPtr = userData;}
