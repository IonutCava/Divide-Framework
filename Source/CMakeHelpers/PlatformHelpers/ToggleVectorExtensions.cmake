...
function (Toggle_Available_Vector_Extensions)
    ...
    if (AVX512_OPT)
        set(EXTENSIONS ${EXTENSIONS} " AVX512 ")
         if (MSVC_COMPILER)
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:/arch:AVX512>")
        else()
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mavx512f>")
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mavx512vl>")
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mavx512dq>")
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mavx2>")
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mpopcnt>")
        endif()
    else()
        ...
        if (AVX2_OPT)
            ...
            if (MSVC_COMPILER)
                add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:/arch:AVX2>")
            else()
                add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mavx2>")
                add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mbmi>")
                add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mpopcnt>")
            endif()
        else()
            ...
            if (AVX_OPT)
                ...
                if (MSVC_COMPILER)
                    add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:/arch:AVX>")
                else()
                    add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mavx>")
                    add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mpopcnt>")
                endif()
            else()
                set(EXTENSIONS ${EXTENSIONS} " NO-AVX ")
                if (NOT MSVC_COMPILER)
                    add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mno-avx>")
                endif()
            endif()
        endif()
    endif()
    ...
    if (SSE42_OPT)
        ...
        if (NOT MSVC_COMPILER)
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-msse4.2>")
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mpopcnt>")
        endif()
    else()
        ...
        if (SSE41_OPT)
            ...
            if (NOT MSVC_COMPILER)
                add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-msse4.1>")
            endif()
        else()
    ...
    if(FMA4_OPT)
        ...
        if (NOT MSVC_COMPILER)
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mfma>")
        endif()
    else()
    ...
    if(BMI2_OPT)
        ...
        if (NOT MSVC_COMPILER)
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mbmi>")
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mlzcnt>")
        endif()
    else()
    ...
    if(F16C_OPT)
        ...
        if (NOT MSVC_COMPILER)
            add_compile_options("$<$<COMPILE_LANGUAGE:CXX,C>:-mf16c>")
        endif()
    else()
