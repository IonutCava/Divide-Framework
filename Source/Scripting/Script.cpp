...
{
    std::vector<std::string> scriptPath{std::string{Paths::Scripts::g_scriptsAtomsLocation.string() + Paths::g_pathSeparator}.c_str(),
                                        std::string{Paths::Scripts::g_scriptsLocation.string() + Paths::g_pathSeparator}.c_str() };
