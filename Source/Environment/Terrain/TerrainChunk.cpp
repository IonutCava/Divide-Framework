...
void TerrainChunk::load(const U8 depth, const uint2 pos, const U32 targetChunkDimension, const uint2 HMSize, BoundingBox& bbInOut)
{
    ...
    const uint2 heightmapDataSize = HMSize / div;
