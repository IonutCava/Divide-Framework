...
namespace Divide
{
    ...
    Scene* SceneManager::load( const Str<256>& sceneName )
    {
    ...
    vector<Str<256>> SceneManager::sceneNameList( const bool sorted ) const
    {
    ...
    bool SceneManager::frameStarted( [[maybe_unused]] const FrameEvent& evt )
    {
        if ( _init )
        {
    ...
    bool SceneManager::frameEnded( [[maybe_unused]] const FrameEvent& evt )
    {
        if ( _init )
        {
    ...
    void SceneManager::editorPreviewNode( const I64 editorPreviewNode ) noexcept
    {
    ...
    const VisibleNodeList<>& SceneManager::getRenderedNodeList() const noexcept
    {
    ...
    std::pair<Texture_ptr, SamplerDescriptor> SceneManager::getSkyTexture() const
    {
