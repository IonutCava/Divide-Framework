...
TEST_CASE( "Can Be Returned By Value", "[data_type_tests]" )
{
    ...
    CHECK_TRUE( can_be_returned_by_value<uint2>() );
    ...
    CHECK_TRUE( can_be_returned_by_value<int2>() );
    CHECK_TRUE( can_be_returned_by_value<vec2<I64>>() );
    CHECK_TRUE( can_be_returned_by_value<float2>() );
    ...
    CHECK_TRUE( can_be_returned_by_value<uint3>() );
    ...
    CHECK_TRUE( can_be_returned_by_value<int3>() );
    CHECK_TRUE( can_be_returned_by_value<vec3<I64>>() );
    CHECK_TRUE( can_be_returned_by_value<float3>() );
    ...
    CHECK_TRUE( can_be_returned_by_value<uint4>() );
    ...
    CHECK_TRUE( can_be_returned_by_value<int4>() );
    CHECK_TRUE( can_be_returned_by_value<vec4<I64>>() );
    CHECK_TRUE( can_be_returned_by_value<float4>() );
    ...
    CHECK_TRUE (can_be_returned_by_value<std::shared_ptr<int2>>());
    CHECK_FALSE (can_be_returned_by_value<std::unique_ptr<float3>>());
}
