...
TEST_CASE( "Float To Char Conversions", "[conversion_tests]" )
{
    ...
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(0.0), 0.0);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(0.f), 0.f);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(0), 0);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(0u), 0u);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(-0.5f), 0.5f);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(10.5f), 10.5f);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(-0.9999), 0.9999);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(543.123), 543.123);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(-123), 123);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(321), 321);
    STATIC_CHECK_COMPARE(ABS_CONSTEXPR(222u), 222u);

    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(0.0), 0.0);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(0.5), 1.0);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(0.999999), 1.0);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(1),  1);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(123.0f), 123.f);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(123.4f),124.f);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(-0.5), 0.0);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(-0.999999), 0.0);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(-1.f), -1.f);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(-123.f), -123.f);
    STATIC_CHECK_COMPARE(CEIL_CONSTEXPR(-123.4), -123.0);


    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(0.0), 0.0);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(0.5), 0.0);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(0.999999), 0.0);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(1), 1);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(123.0f), 123.f);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(123.4f), 123.f);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(-0.5), -1.0);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(-0.999999), -1.);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(-1.0), -1.0);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(-123.0), -123.0);
    STATIC_CHECK_COMPARE(FLOOR_CONSTEXPR(-123.4), -124.0);
