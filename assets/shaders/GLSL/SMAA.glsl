...
DESCRIPTOR_SET_RESOURCE(PER_DRAW, 0) uniform sampler2D edgesTex;
DESCRIPTOR_SET_RESOURCE(PER_DRAW, 1) uniform sampler2D areaTex;
DESCRIPTOR_SET_RESOURCE(PER_DRAW, 2) uniform sampler2D searchTex;
...
DESCRIPTOR_SET_RESOURCE(PER_DRAW, 0) uniform sampler2D colourTex;
DESCRIPTOR_SET_RESOURCE(PER_DRAW, 1) uniform sampler2D blendTex;
