...
DESCRIPTOR_SET_RESOURCE(PER_PASS_SET, TEXTURE_SCENE_NORMALS) uniform sampler2DMS texSceneNormals;
#else//MSAA_SCREEN_TARGET
DESCRIPTOR_SET_RESOURCE(PER_PASS_SET, TEXTURE_SCENE_NORMALS) uniform sampler2D texSceneNormals;
...
#if !defined(NO_SSAO)
DESCRIPTOR_SET_RESOURCE(PER_PASS_SET, TEXTURE_SSAO_SAMPLE) uniform sampler2D texSSAO;
#endif //NO_SSAO
