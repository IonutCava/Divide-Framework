...
DESCRIPTOR_SET_RESOURCE_LAYOUT(PER_BATCH_SET, BUFFER_NODE_INDIRECTION_DATA, std430) coherent COMP_ONLY_R buffer dvd_IndirectionBlock
{
    NodeIndirectionData dvd_IndirectionData[];
};

DESCRIPTOR_SET_RESOURCE_LAYOUT(PER_BATCH_SET, BUFFER_NODE_TRANSFORM_DATA, std430) coherent COMP_ONLY_R buffer dvd_TransformBlock
{
    NodeTransformData dvd_Transforms[];
};

DESCRIPTOR_SET_RESOURCE_LAYOUT(PER_BATCH_SET, BUFFER_GPU_COMMANDS, std430) coherent COMP_ONLY_RW buffer dvd_GPUCmds
{
