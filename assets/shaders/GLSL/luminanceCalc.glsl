...
DESCRIPTOR_SET_RESOURCE_LAYOUT(0, 0, rgba16f) uniform ACCESS_R image2D s_texColor;
DESCRIPTOR_SET_RESOURCE_LAYOUT(0, BUFFER_LUMINANCE_HISTOGRAM, std430) coherent ACCESS_W buffer histogramBuffer
{
    uint histogram[];
};
...
DESCRIPTOR_SET_RESOURCE_LAYOUT(0, 0, r16f) uniform ACCESS_RW image2D s_target;

DESCRIPTOR_SET_RESOURCE_LAYOUT(0, BUFFER_LUMINANCE_HISTOGRAM, std430) coherent ACCESS_RW buffer histogramBuffer
{
    uint histogram[];
};
